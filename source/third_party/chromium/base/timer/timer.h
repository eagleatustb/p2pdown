...
class BASE_EXPORT Timer {
 public:
  ...
  Timer(bool retain_user_task, bool is_repeating,
        const scoped_refptr<SequencedTaskRunner>& particular_runner);
...
class BaseTimerMethodPointer : public Timer {
 public:
  ...
  // patch start huangshaobin ==================================================
  // To make the support for sequence thread pool mechanism.
  BaseTimerMethodPointer(
      const scoped_refptr<SequencedTaskRunner>& particular_runner)
      : Timer(kIsRepeating, kIsRepeating, particular_runner) {}
  // patch end   huangshaobin ==================================================
...
public:
    OneShotTimer() : BaseTimerMethodPointer<Receiver, false>(nullptr) {}
    OneShotTimer(const scoped_refptr<SequencedTaskRunner>& particular_runner)
        : BaseTimerMethodPointer<Receiver, false>(particular_runner) {}
};
...
public:
    RepeatingTimer() : BaseTimerMethodPointer<Receiver, true>(nullptr) {}
    RepeatingTimer(const scoped_refptr<SequencedTaskRunner>& particular_runner)
        : BaseTimerMethodPointer<Receiver, true>(particular_runner) {}
};
// patch end   huangshaobin ====================================================
