...
// path start linkangming
base::Time FileEnumerator::FileInfo::GetCreationTime() const{
  return base::Time::FromFileTime(find_data_.ftCreationTime);
}
// path end linkangming
