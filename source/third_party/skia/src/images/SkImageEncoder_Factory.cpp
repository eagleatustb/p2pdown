...
template EncodeReg* SkTRegistry<SkImageEncoder*, SkImageEncoder::Type>::gHead;
    ...
    static EncodeReg ereg_png(sk_libpng_efactory);
#endif

#ifdef SK_ENABLE_LIBJPEG
    extern SkImageEncoder* sk_libjpeg_efactory(SkImageEncoder::Type);
    static EncodeReg ereg_jpg(sk_libjpeg_efactory);
#endif
